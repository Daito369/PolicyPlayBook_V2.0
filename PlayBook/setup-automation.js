...
function insertOptionsData(spreadsheet) {
  ...
  const data = [
    ...
    ['disclaimer', 'TRUE', '**審査プロセス・基準には言及できかねます。また、審査結果の確約もいたしかねますのでご了承ください。', 1, true, ''],
...
年末年始の営業日に関するご案内
━━━━━━━━━━━━━━━━━━━
Google 広告サポート窓口の年内の最終営業日は、2025 年 12 月 26 日 (金) です。
2026 年年始は、1 月 5 日 (月) より営業を再開いたします。

< お問い合わせへのご回答 > 
窓口は 12 月 26 日 (金) まで営業しておりますが、19 日 (金) 正午以降のお問い合わせは、年始の営業再開までご対応できない可能性がございます。あらかじめご了承ください。

< 広告審査について >
クリスマスや年末年始の期間中も審査は実施されます。
しかしながら、例年混雑が見込まれるので、スムーズな審査完了のためにはお早めの広告入稿を推奨いたします。

< 締切が早いお問い合わせ内容について >
請求先の変更依頼は、社内処理の都合上、12 月 12 日 (金) を締切日とさせていただきます。以降にご依頼いただいた場合や審査にお時間を要する場合は、その完了が年明けとなる可能性がございますことをあらかじめご了承ください。

< ご入金の締切期日について >
銀行振込によるご入金は、各金融機関によってお手続きにかかるお時間が異なるため各金融機関に直接ご確認ください。
通常、銀行振込では 3 - 5 営業日、コンビニからのお支払いでは 1 営業日いただいておりますが、可能な限りお早めのご入金をお願いいたします。クレジットカードによるお支払いは、年末年始も通常どおりご利用いただけます。
━━━━━━━━━━━━━━━━━━━
なお、上記の情報は Google 広告サポート窓口の営業時間でございます。
大変恐れ入りますが、α・β 版機能など営業案件につきましては、各営業担当まで直接ご確認いただきますようご協力お願い申し上げます。`;
